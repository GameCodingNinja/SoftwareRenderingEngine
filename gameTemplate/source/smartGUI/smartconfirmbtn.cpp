...
{
    CMenu * pMenu = CMenuManager::Instance().GetPtrToMenu("confirmation_menu");
    CUIControl * pYesBtn = pMenu->GetPtrToControl("yes_btn");
    CUIControl * pMegLbl = pMenu->GetPtrToControl("message_lbl");
